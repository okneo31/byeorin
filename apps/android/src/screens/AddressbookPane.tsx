...
//
// 확장 popup(apps/extension/entrypoints/popup/screens/AddressbookPane.tsx)에서
// 그대로 이식했다. Addressbook 인스턴스를 props 로 받는 구조라 저장 백엔드
// (확장 ChromeLocalBackend / 안드로이드 LocalStorageBackend) 차이는 App.tsx 가
// 흡수한다 — 이 파일에는 백엔드 의존이 없다.
//
...
//
// 쓰기(추가/삭제) 후에는 같은 앱 안의 다른 화면(SendPane 자동완성)도 즉시
